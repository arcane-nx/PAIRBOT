...
const originalCommand = demoteCommand;
async function demoteCommand(sock, chatId, mentionedJids, message) {
    try {
        ...
        const demotionMessage = 
            ...
            `👑 *𝐃𝐞𝐦𝐨𝐭𝐞𝐝 𝐁𝐲:* @${message.key.participant ? message.key.participant.split('@')[0] : message.key.remoteJid.split('@')[0]}\n\n` +
...
{ demoteCommand, handleDemotionEvent };
