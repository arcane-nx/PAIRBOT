...
// Leave Group Command
async function leavegcCommand(sock, chatId, msg) {
    try {
...
async function addCommand(sock, chatId, msg, args) {
    try {
        ...
        if (!isBotAdmin) {
            await sock.sendMessage(chatId, {
                text: '❌ ❤️‍🔥🎊𝐄𝐌𝐌𝐘𝐇𝐄𝐍𝐙-𝐕3.1🎊❤️‍🔥 must be an admin to add members.',
                ...channelInfo
            });
            return;
        }
